...
/* Not sure what being asked member who joined last or member who checkin the facilties last*/
...
SELECT CONCAT (Members.firstname,'',Members.surname)AS membername,Facilities.name
FROM Bookings
LEFT JOIN Members
